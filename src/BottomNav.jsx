...
const BottomNav = ({ navigate, activeScreen }) => {
    return (
        <nav className="bottom-nav">
            <div className={`nav-item ${activeScreen === 'home' ? 'active' : ''}`} onClick={() => navigate('home')}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                <span>Home</span>
            </div>
            <div className={`nav-item ${activeScreen === 'catalog' ? 'active' : ''}`} onClick={() => navigate('catalog')}>
            ...
            <div className={`nav-item cart ${activeScreen === 'cart' ? 'active' : ''}`} onClick={() => navigate('cart')}>
            ...
            <div className={`nav-item ${activeScreen === 'profile' ? 'active' : ''}`} onClick={() => navigate('profile')}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                <span>Perfil</span>
            </div>
            <div className={`nav-item ${activeScreen === 'notifications' ? 'active' : ''}`} onClick={() => navigate('notifications')}>
